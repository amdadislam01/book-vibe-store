...
const Navbar = () => {
    const links = (
        <>
            <li className="m-2"><a className='font-work' href="#">Home</a></li>
            <li className="m-2"><a className='font-work' href="#">Listed Books</a></li>
            <li className="m-2"><a className='font-work' href="#">Pages to Read</a></li>
        </>
    );
