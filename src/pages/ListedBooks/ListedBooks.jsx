...
import { FaBook, FaMapMarkerAlt, FaUser } from 'react-icons/fa';
                ...
                <Tabs>
                    ...
                    <TabPanel>
                        <div className="grid gap-6">
                            {
                                bookReadList.map((rbook) => <div className="flex flex-col md:flex-row gap-6 bg-white border border-gray-300 rounded-xl shadow-sm p-5 hover:shadow-md transition">
                    ...
                    <TabPanel>
                        <h2 className='text-center text-2xl font-semibold font-work'>No Whishlist Books</h2>
                    </TabPanel>
                </Tabs>
            </div>
        </div>
